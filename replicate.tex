...
\usepackage[pdfauthor={Tolga Girici},
...
% \date{\vspace{-12pt}{\small NOTE: Corresponding author: Tolga Girici, tgirici@etu.edu.tr}}
\date{}
...
\begin{figure} [htb]
	...
	\begin{tikzpicture}[thick,fill opacity=1,scale=0.68, every node/.style={scale=0.68}]
